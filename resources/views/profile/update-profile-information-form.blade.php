    ...
    <x-slot name="form">
        ...
        <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
            ...
            <div class="mt-2" x-show="! photoPreview">
                ...
                <img class="h-[100px] w-[100px] rounded-full object-cover" src="/storage/{{Auth::user()->profile_photo_path }}"
                    alt="{{ Auth::user()->first_name }}" />
                @else
                <img class="h-[100px] w-[100px] rounded-full object-cover" src="{{Auth::user()->profile_photo_url }}"
                    alt="{{ Auth::user()->first_name }}" />
                @endif
            </div>
