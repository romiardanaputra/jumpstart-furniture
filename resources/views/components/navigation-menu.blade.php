            ...
            <div id="drawer-right-example"
                ...
                <div class="h-[75%] overflow-y-scroll">
                    ...
                    <div class="w-full pt-5 flex flex-row space-x-10 justify-center items-center">
                        <img src="{{ asset('storage/' . $item->product->product_image) }}" alt="{{ $item->product->product_name }}" class="h-[84px] w-[70px]">
                        <div class="flex flex-col space-y-1">
                            <p class="text-sm">{{ $item->product->product_name }}</p>
                            <p class="text-sm">{{ $item->quantity }} x ${{ $item->product->product_price }}</p>
                            <p class="text-sm text-gray-400">Color : {{ $item->product->product_color }}</p>
                        </div>
