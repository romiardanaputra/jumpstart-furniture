...
<div
    {{ $attributes->merge(['class' => "flex items-start p-4 border-l-4 rounded-r-lg {$style['bg']} {$style['border']} {$style['text']}"]) }}
...
>
    ...
    @if($dismissible)
        <button
            ...
            class="ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 inline-flex h-8 w-8 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none"
        >
