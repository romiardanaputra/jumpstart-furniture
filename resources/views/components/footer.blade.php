        ...
        <footer class="p-4 sm:p-6 dark:bg-gray-900">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="{{ route('landing') }}" class="flex items-center">
                        <img src="{{ asset('assets/icons/Jumpstart.png') }}" class="mr-3 h-[50px] w-[50px]" alt="FlowBite Logo" />
                        <span
                            class="self-center text-[20px] font-semibold whitespace-nowrap dark:text-white font-open-sans">Jumpstart</span>
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            ...
                            <li class="mb-4">
                                <a href="{{ route('blog') }}" class="hover:underline">Our Blog</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="text-gray-600 dark:text-gray-400">
                            <li class="mb-4">
                                <a href="{{ route('term') }}" class="hover:underline">Privacy Policy</a>
                            </li>
                            <li>
                                <a href="{{ route('term') }}" class="hover:underline">Terms &amp; Conditions</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a
                        href="{{ route('landing') }}" class="hover:underline">Romiardana</a>. All Rights Reserved.
                </span>
